...
if isempty "${PWD}"; then
    ...
    # copy MAIL to contact_form
    cp -f /tmp/mail.php ./
    echo >&2 "✅ mail.php has been successfully copied to ${PWD}"
    ...
    chmod 777 -R ./
    chmod 644 -R ./mail.php
    echo >&2 "✅ permissions for development ${PWD}/"
